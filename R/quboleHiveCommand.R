...
#'  @export
#quboleHiveCommand<-function(query=NULL, script_location=NULL, macros=NULL , tags=NULL, sample_size=NULL, cluster_label=NULL, notify=NULL, name=NULL, poll_interval=15
